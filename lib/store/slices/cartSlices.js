...
export { manageCart };
export const { storeCartDetails, modifyCart, removeActiveItem, modifyQuantity, removeCartItems, resetAllCart, storeOrderplacement, setOrderPayment, activeCartDisplay } = manageCart.actions;