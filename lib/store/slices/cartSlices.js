...
export { manageCart };
export const { storeCartDetails, modifyCart, removeActiveItem, modifyQuantity, removeCartItems, resetAllCart, storeOrderplacement, setOrderPayment } = manageCart.actions;