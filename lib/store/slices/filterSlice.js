...
const initialState = {
    filteredProductList: [],
    selectedBrandIds: [],      // State for storing selected brand IDs
    selectedCategoryIds: [],   // State for storing selected category/subcategory IDs
...
export const { storeFilteredProductList, toggleBrand, toggleCategory, setPriceRange } = manageFilterSlice.actions;
